...
import numpy as np
import misc
import misc.lp_matrix_multiply
...
class TestNaive_multiplication_rdd(ReusedPySparkTestCase):
    def setUp(self):
        ...
        X_triangle = np.array([[1, 0, 0, 0], [2, 1, 0, 0], [3, 4, 1, 0], [5, 6, 7, 1]])
        self.y_shape = y.shape
        self.X_shape = X_triangle.shape
        self.X_real = X_triangle+X_triangle.T-np.eye(4)
    ...
    def test_naive_multiplication_rdd(self):
        computed_result = misc.lp_matrix_multiply.naive_multiplication_rdd(
