...
from shared.OwnArguments import OwnArgumentParser
from unittest.mock import patch
import sys
import pprint


class TestOwnArgumentParser(TestCase):
    def setUp(self):
    ...
    def test_cast_to(self):
        args = OwnArgumentParser(name='did', nargs='*')
    ...
    def test_property_all_args(self):
        args = OwnArgumentParser(name='--did', nargs='*')
        self.assertIsInstance(args.all_args, dict)