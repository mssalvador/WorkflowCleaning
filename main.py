...
if __name__ == '__main__':
    ...
    arguments.add_argument('--job_args', nargs='*', type=dict)
    arguments.add_argument('--input_data', type=str)
    arguments.add_argument('--features', type=list, nargs='*')
    ...
    #     all_args['algo_params'] = arguments.job_args
    #
    ...
    try:
        data_frame = job_module.run(sc, **arguments.all_values)
